/*____________________________________________________________________________
	...
	$Id: downloadformat.h,v 1.8 2003/09/16 17:34:53 kgk Exp $
____________________________________________________________________________*/
...
class DownloadFormat {
 ...
 public:
    ...
    virtual Error GetSupportedFormats(DownloadFormatInfo* info, uint32_t index) = 0;
    virtual Error ReadDownloadFile(const char* url, std::vector<DownloadItem*>* items) = 0;
...
/* arch-tag: 5cb63910-db72-4af3-baa6-d5c38be72c02
